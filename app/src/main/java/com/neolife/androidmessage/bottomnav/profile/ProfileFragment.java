package com.neolife.androidmessage.bottomnav.profile;
...
import com.neolife.androidmessage.LoginActivity;
import com.neolife.androidmessage.databinding.FragmentProfileBinding;
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            FirebaseDatabase.getInstance().getReference().child("Users")
                                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("profileImage").setValue(uri.toString());
                                        }
                                    });
                        }
                    });
